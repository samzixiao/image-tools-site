...
assert.ok(styles.includes('.workspace .shape-icon { font-size: 22px !important;') && styles.includes('font-size: 21px !important;'), "Main editor shapes and privacy stickers must use the enlarged controls");
assert.ok(styles.includes('.workspace .controls .caption-add,') && styles.includes('font-size: 15px !important;') && styles.includes('font-weight: 700 !important;'), "Add-layer actions must be larger and bold");
