...
assert.ok(styles.includes('.workspace .shape-icon { font-size: 21px !important;') && styles.includes('font-size: 20px !important;'), "Main editor shapes and privacy stickers must use the enlarged controls");
